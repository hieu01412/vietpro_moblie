...
// xác thực ng dùng đã click nút submit chưa
if(isset($_POST['submit'])) {
	// server nhận 2 biến để xử lý
	$mail = $_POST['mail'];
	$pass = $_POST['pass'];

	// server kết nối tới csdl tìm xem có 2 giá trị không
	// cú pháp điều kiện: WHERE tentruong=giatri;
